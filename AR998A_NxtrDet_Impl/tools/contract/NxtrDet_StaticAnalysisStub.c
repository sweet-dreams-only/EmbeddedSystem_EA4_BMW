...
static const uint16 ImcArbnModId = NXTRDET_IMCARBNMODID_CNT_U16;
...
#if (STD_ON == NXTRDET_IMCARBN)
	static const boolean ImcArbnDet = TRUE;
#else
	static const boolean ImcArbnDet = FALSE;
#endif
