 ...
 ** Module: E2EPW_BmwMsgSlot274Bas0Repn8BusFrChA_sigGroup_SU_EPS_sigGroup_SU_EPS_tx.c
...
#define BmwMsgSlot274Bas0Repn8BusFrChA_START_SEC_VAR_INIT_UNSPECIFIED
#include "BmwMsgSlot274Bas0Repn8BusFrChA_MemMap.h"

STATIC VAR (E2E_P01ProtectStateType, BmwMsgSlot274Bas0Repn8BusFrChA_VAR_INIT)
    StateVal_sigGroup_SU_EPS_sigGroup_SU_EPS =
{
    0  /* Counter */
};

STATIC P2VAR ( E2E_P01ProtectStateType
             , BmwMsgSlot274Bas0Repn8BusFrChA_VAR_INIT
             , BmwMsgSlot274Bas0Repn8BusFrChA_VAR_INIT
             )
    State_sigGroup_SU_EPS_sigGroup_SU_EPS =
        &StateVal_sigGroup_SU_EPS_sigGroup_SU_EPS;

#define BmwMsgSlot274Bas0Repn8BusFrChA_STOP_SEC_VAR_INIT_UNSPECIFIED
#include "BmwMsgSlot274Bas0Repn8BusFrChA_MemMap.h"

#define BmwMsgSlot274Bas0Repn8BusFrChA_START_SEC_VAR_NOINIT_UNSPECIFIED
#include "BmwMsgSlot274Bas0Repn8BusFrChA_MemMap.h"
/**********************************************************
 ...
 **********************************************************/
/* PRQA S 3218 2 */
STATIC VAR (uint8, BmwMsgSlot274Bas0Repn8BusFrChA_VAR_NOINIT)
    ppa_sigGroup_SU_EPS_sigGroup_SU_EPS_au8 [8];

#define BmwMsgSlot274Bas0Repn8BusFrChA_STOP_SEC_VAR_NOINIT_UNSPECIFIED
#include "BmwMsgSlot274Bas0Repn8BusFrChA_MemMap.h"

#define BmwMsgSlot274Bas0Repn8BusFrChA_START_SEC_CONST_UNSPECIFIED
#include "BmwMsgSlot274Bas0Repn8BusFrChA_MemMap.h"
/**********************************************************
 * MISRA RULE 8.7 VIOLATION:
 * Error Message : Msg(4:3218) File scope static,
 ...
 **********************************************************/
/* PRQA S 3218 2 */
STATIC CONST (E2E_P01ConfigType, BmwMsgSlot274Bas0Repn8BusFrChA_CONST)
    ConfigVal_sigGroup_SU_EPS_sigGroup_SU_EPS =
{
      52
    , 56
    , 131
...
#define BmwMsgSlot274Bas0Repn8BusFrChA_STOP_SEC_CONST_UNSPECIFIED
#include "BmwMsgSlot274Bas0Repn8BusFrChA_MemMap.h"
 ...
 **********************************************************/
FUNC (void, BmwMsgSlot274Bas0Repn8BusFrChA_CODE) E2EPW_WriteInit_sigGroup_SU_EPS_sigGroup_SU_EPS (void)
{
    State_sigGroup_SU_EPS_sigGroup_SU_EPS = &StateVal_sigGroup_SU_EPS_sigGroup_SU_EPS;
    State_sigGroup_SU_EPS_sigGroup_SU_EPS->Counter = 0;
}
...
{
    return State_sigGroup_SU_EPS_sigGroup_SU_EPS;
}

/**********************************************************
 * Function name: E2EPW_Write_sigGroup_SU_EPS_sigGroup_SU_EPS (sigGroup_SU_EPS1 *  AppData);
 ...
 * Remarks:       None
 **********************************************************/
FUNC (uint32, BmwMsgSlot274Bas0Repn8BusFrChA_CODE) E2EPW_Write_sigGroup_SU_EPS_sigGroup_SU_EPS
    (P2VAR (sigGroup_SU_EPS1, AUTOMATIC, BmwMsgSlot274Bas0Repn8BusFrChA_VAR_INIT) AppData)
{
    ...
    P2CONST (E2E_P01ConfigType, AUTOMATIC, BmwMsgSlot274Bas0Repn8BusFrChA_CONST)
        Config_sigGroup_SU_EPS_sigGroup_SU_EPS = &ConfigVal_sigGroup_SU_EPS_sigGroup_SU_EPS;
    ...
    {
        E2EPW_Marshal_sigGroup_SU_EPS ( AppData, ppa_sigGroup_SU_EPS_sigGroup_SU_EPS_au8 );
    }

    if (status_u32 == status_ok_u32)
    {
        ret_u8 = E2E_P01Protect
                     ( Config_sigGroup_SU_EPS_sigGroup_SU_EPS
                     , State_sigGroup_SU_EPS_sigGroup_SU_EPS
                     , ppa_sigGroup_SU_EPS_sigGroup_SU_EPS_au8
                     );
    ...
    if (status_u32 == status_ok_u32)
    {
        uint16 crcoffset_u16 = Config_sigGroup_SU_EPS_sigGroup_SU_EPS->CRCOffset/8;
        uint16 cntoffset_u16 = Config_sigGroup_SU_EPS_sigGroup_SU_EPS->CounterOffset/8;
/**********************************************************
 ...
 **********************************************************/
/* PRQA S 505 1*/
        AppData->CRC_SU_EPS = ppa_sigGroup_SU_EPS_sigGroup_SU_EPS_au8[crcoffset_u16];
        AppData->ALIV_SU_EPS = ((ppa_sigGroup_SU_EPS_sigGroup_SU_EPS_au8[cntoffset_u16]>>4));
    }

    if (status_u32 == status_ok_u32)
    {
        ret_u8 = Rte_Write_sigGroup_SU_EPS_sigGroup_SU_EPS ( AppData );
