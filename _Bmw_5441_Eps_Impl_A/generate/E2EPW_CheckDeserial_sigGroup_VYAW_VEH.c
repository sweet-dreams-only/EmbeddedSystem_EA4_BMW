 ...
 ** Module: E2EPW_CheckDeserial_sigGroup_VYAW_VEH.c
...
/******************************************************************
 * Function name      : E2EPW_CheckDeserial_sigGroup_VYAW_VEH
 ...
 * Remarks            : none
 ******************************************************************/
FUNC (uint8, E2EPW_CODE) E2EPW_CheckDeserial_sigGroup_VYAW_VEH
    ( P2CONST (sigGroup_VYAW_VEH1, AUTOMATIC, E2EPW_APPL_DATA) pde )
{
    ...
    if ((pde->VYAW_VEH_dummy_12_15 & 0xf0u) != 0)
    {
        ret = E2EPW_DESERIAL_ERR;
    }
