 ...
 ** Module: E2EPW_CheckDeserial_sigGroup_V_VEH.c
...
/******************************************************************
 * Function name      : E2EPW_CheckDeserial_sigGroup_V_VEH
 ...
 * Remarks            : none
 ******************************************************************/
FUNC (uint8, E2EPW_CODE) E2EPW_CheckDeserial_sigGroup_V_VEH
    ( P2CONST (sigGroup_V_VEH1, AUTOMATIC, E2EPW_APPL_DATA) pde )
{
    ...
    if ((pde->V_VEH_dummy_39_39 & 0xfeu) != 0)
    {
        ret = E2EPW_DESERIAL_ERR;
    }
