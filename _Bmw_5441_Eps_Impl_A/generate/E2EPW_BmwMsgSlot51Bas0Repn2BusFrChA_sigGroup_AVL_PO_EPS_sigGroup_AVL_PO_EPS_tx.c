 ...
 ** Module: E2EPW_BmwMsgSlot51Bas0Repn2BusFrChA_sigGroup_AVL_PO_EPS_sigGroup_AVL_PO_EPS_tx.c
...
#define BmwMsgSlot51Bas0Repn2BusFrChA_START_SEC_VAR_INIT_UNSPECIFIED
#include "BmwMsgSlot51Bas0Repn2BusFrChA_MemMap.h"

STATIC VAR (E2E_P01ProtectStateType, BmwMsgSlot51Bas0Repn2BusFrChA_VAR_INIT)
    StateVal_sigGroup_AVL_PO_EPS_sigGroup_AVL_PO_EPS =
{
    0  /* Counter */
};

STATIC P2VAR ( E2E_P01ProtectStateType
             , BmwMsgSlot51Bas0Repn2BusFrChA_VAR_INIT
             , BmwMsgSlot51Bas0Repn2BusFrChA_VAR_INIT
             )
    State_sigGroup_AVL_PO_EPS_sigGroup_AVL_PO_EPS =
        &StateVal_sigGroup_AVL_PO_EPS_sigGroup_AVL_PO_EPS;

#define BmwMsgSlot51Bas0Repn2BusFrChA_STOP_SEC_VAR_INIT_UNSPECIFIED
#include "BmwMsgSlot51Bas0Repn2BusFrChA_MemMap.h"

#define BmwMsgSlot51Bas0Repn2BusFrChA_START_SEC_VAR_NOINIT_UNSPECIFIED
#include "BmwMsgSlot51Bas0Repn2BusFrChA_MemMap.h"
/**********************************************************
 ...
 **********************************************************/
/* PRQA S 3218 2 */
STATIC VAR (uint8, BmwMsgSlot51Bas0Repn2BusFrChA_VAR_NOINIT)
    ppa_sigGroup_AVL_PO_EPS_sigGroup_AVL_PO_EPS_au8 [8];

#define BmwMsgSlot51Bas0Repn2BusFrChA_STOP_SEC_VAR_NOINIT_UNSPECIFIED
#include "BmwMsgSlot51Bas0Repn2BusFrChA_MemMap.h"

#define BmwMsgSlot51Bas0Repn2BusFrChA_START_SEC_CONST_UNSPECIFIED
#include "BmwMsgSlot51Bas0Repn2BusFrChA_MemMap.h"
/**********************************************************
 * MISRA RULE 8.7 VIOLATION:
 * Error Message : Msg(4:3218) File scope static,
 ...
 **********************************************************/
/* PRQA S 3218 2 */
STATIC CONST (E2E_P01ConfigType, BmwMsgSlot51Bas0Repn2BusFrChA_CONST)
    ConfigVal_sigGroup_AVL_PO_EPS_sigGroup_AVL_PO_EPS =
{
      8
    , 0
    , 186
...
#define BmwMsgSlot51Bas0Repn2BusFrChA_STOP_SEC_CONST_UNSPECIFIED
#include "BmwMsgSlot51Bas0Repn2BusFrChA_MemMap.h"
 ...
 **********************************************************/
FUNC (void, BmwMsgSlot51Bas0Repn2BusFrChA_CODE) E2EPW_WriteInit_sigGroup_AVL_PO_EPS_sigGroup_AVL_PO_EPS (void)
{
    State_sigGroup_AVL_PO_EPS_sigGroup_AVL_PO_EPS = &StateVal_sigGroup_AVL_PO_EPS_sigGroup_AVL_PO_EPS;
    State_sigGroup_AVL_PO_EPS_sigGroup_AVL_PO_EPS->Counter = 0;
}
...
{
    return State_sigGroup_AVL_PO_EPS_sigGroup_AVL_PO_EPS;
}
 ...
 * Remarks:       None
 **********************************************************/
FUNC (uint32, BmwMsgSlot51Bas0Repn2BusFrChA_CODE) E2EPW_Write_sigGroup_AVL_PO_EPS_sigGroup_AVL_PO_EPS
    (P2VAR (sigGroup_AVL_PO_EPS1, AUTOMATIC, BmwMsgSlot51Bas0Repn2BusFrChA_VAR_INIT) AppData)
{
    ...
    P2CONST (E2E_P01ConfigType, AUTOMATIC, BmwMsgSlot51Bas0Repn2BusFrChA_CONST)
        Config_sigGroup_AVL_PO_EPS_sigGroup_AVL_PO_EPS = &ConfigVal_sigGroup_AVL_PO_EPS_sigGroup_AVL_PO_EPS;
    ...
    {
        E2EPW_Marshal_sigGroup_AVL_PO_EPS ( AppData, ppa_sigGroup_AVL_PO_EPS_sigGroup_AVL_PO_EPS_au8 );
    }

    if (status_u32 == status_ok_u32)
    {
        ret_u8 = E2E_P01Protect
                     ( Config_sigGroup_AVL_PO_EPS_sigGroup_AVL_PO_EPS
                     , State_sigGroup_AVL_PO_EPS_sigGroup_AVL_PO_EPS
                     , ppa_sigGroup_AVL_PO_EPS_sigGroup_AVL_PO_EPS_au8
                     );
    ...
    if (status_u32 == status_ok_u32)
    {
        uint16 crcoffset_u16 = Config_sigGroup_AVL_PO_EPS_sigGroup_AVL_PO_EPS->CRCOffset/8;
        uint16 cntoffset_u16 = Config_sigGroup_AVL_PO_EPS_sigGroup_AVL_PO_EPS->CounterOffset/8;
/**********************************************************
 ...
 **********************************************************/
/* PRQA S 505 1*/
        AppData->CRC_AVL_PO_EPS = ppa_sigGroup_AVL_PO_EPS_sigGroup_AVL_PO_EPS_au8[crcoffset_u16];
        AppData->ALIV_AVL_PO_EPS = (ppa_sigGroup_AVL_PO_EPS_sigGroup_AVL_PO_EPS_au8[cntoffset_u16] & 0x0F);
    }

    if (status_u32 == status_ok_u32)
    {
        ret_u8 = Rte_Write_sigGroup_AVL_PO_EPS_sigGroup_AVL_PO_EPS ( AppData );
