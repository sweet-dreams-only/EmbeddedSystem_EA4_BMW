 ...
 ** Module: E2EPW_Marshal_sigGroup_TAR_QTA_STRMOM_DV.c
...
/******************************************************************
 * Function name      : E2EPW_Marshal_sigGroup_TAR_QTA_STRMOM_DV
 ...
 * Remarks            : none
 ******************************************************************/
FUNC (void, E2EPW_CODE) E2EPW_Marshal_sigGroup_TAR_QTA_STRMOM_DV
    ...
    )
{
    ...
    /* packing signal TAR_QTA_STRMOM_DV_dummy_12_15 */
    src = (P2CONST (uint8, AUTOMATIC, E2EPW_APPL_DATA)) &(pde->TAR_QTA_STRMOM_DV_dummy_12_15);
    ppa[1] &= 0x0f;
    ppa[1] |= (src[0] << 4) & 0xf0;
