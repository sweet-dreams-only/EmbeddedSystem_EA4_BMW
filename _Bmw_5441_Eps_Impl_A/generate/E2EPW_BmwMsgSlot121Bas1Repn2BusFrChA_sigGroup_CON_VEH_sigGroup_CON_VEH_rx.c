 ...
 ** Module: E2EPW_BmwMsgSlot121Bas1Repn2BusFrChA_sigGroup_CON_VEH_sigGroup_CON_VEH_rx.c
...
#define BmwMsgSlot121Bas1Repn2BusFrChA_START_SEC_VAR_INIT_UNSPECIFIED
#include "BmwMsgSlot121Bas1Repn2BusFrChA_MemMap.h"

STATIC VAR (E2E_P01CheckStateType, BmwMsgSlot121Bas1Repn2BusFrChA_VAR_INIT)
    StateVal_sigGroup_CON_VEH_sigGroup_CON_VEH =
{
      0                        /* LastValidCounter */
    , 0                        /* MaxDeltaCounter  */
...
STATIC P2VAR ( E2E_P01CheckStateType
             , BmwMsgSlot121Bas1Repn2BusFrChA_VAR_INIT
             , BmwMsgSlot121Bas1Repn2BusFrChA_VAR_INIT
             )
    State_sigGroup_CON_VEH_sigGroup_CON_VEH =
        &StateVal_sigGroup_CON_VEH_sigGroup_CON_VEH;

#define BmwMsgSlot121Bas1Repn2BusFrChA_STOP_SEC_VAR_INIT_UNSPECIFIED
#include "BmwMsgSlot121Bas1Repn2BusFrChA_MemMap.h"

#define BmwMsgSlot121Bas1Repn2BusFrChA_START_SEC_VAR_NOINIT_UNSPECIFIED
#include "BmwMsgSlot121Bas1Repn2BusFrChA_MemMap.h"
/**********************************************************
 ...
 **********************************************************/
/* PRQA S 3218 2 */
STATIC VAR (uint8, BmwMsgSlot121Bas1Repn2BusFrChA_VAR_NOINIT)
    ppa_sigGroup_CON_VEH_sigGroup_CON_VEH_au8 [8];

#define BmwMsgSlot121Bas1Repn2BusFrChA_STOP_SEC_VAR_NOINIT_UNSPECIFIED
#include "BmwMsgSlot121Bas1Repn2BusFrChA_MemMap.h"

#define BmwMsgSlot121Bas1Repn2BusFrChA_START_SEC_CONST_UNSPECIFIED
#include "BmwMsgSlot121Bas1Repn2BusFrChA_MemMap.h"
/**********************************************************
 * MISRA RULE 8.7 VIOLATION:
 * Error Message : Msg(4:3218) File scope static,
 ...
 **********************************************************/
/* PRQA S 3218 2 */
STATIC CONST (E2E_P01ConfigType, BmwMsgSlot121Bas1Repn2BusFrChA_CONST)
    ConfigVal_sigGroup_CON_VEH_sigGroup_CON_VEH =
{
      8
    , 0
    , 197
...
#define BmwMsgSlot121Bas1Repn2BusFrChA_STOP_SEC_CONST_UNSPECIFIED
#include "BmwMsgSlot121Bas1Repn2BusFrChA_MemMap.h"
 ...
 **********************************************************/
FUNC (void, BmwMsgSlot121Bas1Repn2BusFrChA_CODE) E2EPW_ReadInit_sigGroup_CON_VEH_sigGroup_CON_VEH (void)
{
    State_sigGroup_CON_VEH_sigGroup_CON_VEH = &StateVal_sigGroup_CON_VEH_sigGroup_CON_VEH;
    State_sigGroup_CON_VEH_sigGroup_CON_VEH->LastValidCounter = 0;
    State_sigGroup_CON_VEH_sigGroup_CON_VEH->MaxDeltaCounter  = 0;
    State_sigGroup_CON_VEH_sigGroup_CON_VEH->WaitForFirstData = TRUE;
    State_sigGroup_CON_VEH_sigGroup_CON_VEH->NewDataAvailable = FALSE;
    State_sigGroup_CON_VEH_sigGroup_CON_VEH->LostData         = 0;
    State_sigGroup_CON_VEH_sigGroup_CON_VEH->Status           = E2E_P01STATUS_NONEWDATA;
    State_sigGroup_CON_VEH_sigGroup_CON_VEH->SyncCounter      = 0;
    State_sigGroup_CON_VEH_sigGroup_CON_VEH->NoNewOrRepeatedDataCounter = 0;
}
...
{
    return State_sigGroup_CON_VEH_sigGroup_CON_VEH;
}
 ...
 * Remarks:       None
 **********************************************************/
FUNC (uint32, BmwMsgSlot121Bas1Repn2BusFrChA_CODE) E2EPW_Read_sigGroup_CON_VEH_sigGroup_CON_VEH
    ( P2VAR (sigGroup_CON_VEH1, AUTOMATIC, BmwMsgSlot121Bas1Repn2BusFrChA_VAR_INIT) AppData)
{
    ...
    P2CONST (E2E_P01ConfigType, AUTOMATIC, BmwMsgSlot121Bas1Repn2BusFrChA_CONST)
        Config_sigGroup_CON_VEH_sigGroup_CON_VEH = &ConfigVal_sigGroup_CON_VEH_sigGroup_CON_VEH;

    State_sigGroup_CON_VEH_sigGroup_CON_VEH->NewDataAvailable =
        Rte_IsUpdated_sigGroup_CON_VEH_sigGroup_CON_VEH ();

    if ((State_sigGroup_CON_VEH_sigGroup_CON_VEH->NewDataAvailable != FALSE))
    {
        if (AppData == NULL_PTR)
        {
        ...
        if (status_u32 == status_ok_u32)
        {
            /* Return-value of Rte_Read does not affect
               following workflow.
            */
            ret_rte_u8 = Rte_Read_sigGroup_CON_VEH_sigGroup_CON_VEH (AppData);
        }

        if (status_u32 == status_ok_u32)
        {
            ret_u8 = E2EPW_CheckDeserial_sigGroup_CON_VEH (AppData);
        ...
        if (status_u32 == status_ok_u32)
        {
            uint16 crcoffset_u16 = Config_sigGroup_CON_VEH_sigGroup_CON_VEH->CRCOffset >> 3u;
            uint16 cntoffset_u16 = Config_sigGroup_CON_VEH_sigGroup_CON_VEH->CounterOffset >> 3u;
            E2EPW_Marshal_sigGroup_CON_VEH ( AppData, ppa_sigGroup_CON_VEH_sigGroup_CON_VEH_au8 );
/**********************************************************
 ...
 **********************************************************/
/* PRQA S 505 1*/
            ppa_sigGroup_CON_VEH_sigGroup_CON_VEH_au8[crcoffset_u16]  = AppData->CRC_CON_VEH;
            ppa_sigGroup_CON_VEH_sigGroup_CON_VEH_au8[cntoffset_u16] &= (uint8)0xf0;
            ppa_sigGroup_CON_VEH_sigGroup_CON_VEH_au8[cntoffset_u16] |= AppData->ALIV_CON_VEH;
        }
    }
    ...
    {
        ret_u8 = E2E_P01Check
                     ( Config_sigGroup_CON_VEH_sigGroup_CON_VEH
                     , State_sigGroup_CON_VEH_sigGroup_CON_VEH
                     , ppa_sigGroup_CON_VEH_sigGroup_CON_VEH_au8
                     );
        status_u32 &= 0x80FFFF00U;
        status_u32 |= ret_u8;
        status_u32 |= (uint32)(State_sigGroup_CON_VEH_sigGroup_CON_VEH->Status<<24);
    }
