 ...
 ** Module: E2EPW_BmwMsgSlot49Bas0Repn2BusFrChA_sigGroup_AVL_FORC_GRD_sigGroup_AVL_FORC_GRD_tx.c
...
STATIC VAR (E2E_P01ProtectStateType, BmwMsgSlot49Bas0Repn2BusFrChA_VAR_INIT)
    StateVal_sigGroup_AVL_FORC_GRD_sigGroup_AVL_FORC_GRD =
{
    0  /* Counter */
};
...
STATIC P2VAR ( E2E_P01ProtectStateType
    ...
    State_sigGroup_AVL_FORC_GRD_sigGroup_AVL_FORC_GRD =
        &StateVal_sigGroup_AVL_FORC_GRD_sigGroup_AVL_FORC_GRD;
...
STATIC VAR (uint8, BmwMsgSlot49Bas0Repn2BusFrChA_VAR_NOINIT)
    ppa_sigGroup_AVL_FORC_GRD_sigGroup_AVL_FORC_GRD_au8 [5];
...
STATIC CONST (E2E_P01ConfigType, BmwMsgSlot49Bas0Repn2BusFrChA_CONST)
    ConfigVal_sigGroup_AVL_FORC_GRD_sigGroup_AVL_FORC_GRD =
{
      8
    , 0
    , 190
 ...
 **********************************************************/
FUNC (void, BmwMsgSlot49Bas0Repn2BusFrChA_CODE) E2EPW_WriteInit_sigGroup_AVL_FORC_GRD_sigGroup_AVL_FORC_GRD (void)
{
    State_sigGroup_AVL_FORC_GRD_sigGroup_AVL_FORC_GRD = &StateVal_sigGroup_AVL_FORC_GRD_sigGroup_AVL_FORC_GRD;
    State_sigGroup_AVL_FORC_GRD_sigGroup_AVL_FORC_GRD->Counter = 0;
}
...
{
    return State_sigGroup_AVL_FORC_GRD_sigGroup_AVL_FORC_GRD;
}

/**********************************************************
 * Function name: E2EPW_Write_sigGroup_AVL_FORC_GRD_sigGroup_AVL_FORC_GRD (sigGroup_AVL_FORC_GRD1 *  AppData);
 ...
 * Remarks:       None
 **********************************************************/
FUNC (uint32, BmwMsgSlot49Bas0Repn2BusFrChA_CODE) E2EPW_Write_sigGroup_AVL_FORC_GRD_sigGroup_AVL_FORC_GRD
    (P2VAR (sigGroup_AVL_FORC_GRD1, AUTOMATIC, BmwMsgSlot49Bas0Repn2BusFrChA_VAR_INIT) AppData)
{
    ...
    P2CONST (E2E_P01ConfigType, AUTOMATIC, BmwMsgSlot49Bas0Repn2BusFrChA_CONST)
        Config_sigGroup_AVL_FORC_GRD_sigGroup_AVL_FORC_GRD = &ConfigVal_sigGroup_AVL_FORC_GRD_sigGroup_AVL_FORC_GRD;
    ...
    {
        E2EPW_Marshal_sigGroup_AVL_FORC_GRD ( AppData, ppa_sigGroup_AVL_FORC_GRD_sigGroup_AVL_FORC_GRD_au8 );
    }

    if (status_u32 == status_ok_u32)
    {
        ret_u8 = E2E_P01Protect
                     ( Config_sigGroup_AVL_FORC_GRD_sigGroup_AVL_FORC_GRD
                     , State_sigGroup_AVL_FORC_GRD_sigGroup_AVL_FORC_GRD
                     , ppa_sigGroup_AVL_FORC_GRD_sigGroup_AVL_FORC_GRD_au8
                     );
    ...
    if (status_u32 == status_ok_u32)
    {
        uint16 crcoffset_u16 = Config_sigGroup_AVL_FORC_GRD_sigGroup_AVL_FORC_GRD->CRCOffset/8;
        uint16 cntoffset_u16 = Config_sigGroup_AVL_FORC_GRD_sigGroup_AVL_FORC_GRD->CounterOffset/8;
/**********************************************************
 ...
 **********************************************************/
/* PRQA S 505 1*/
        AppData->CRC_AVL_FORC_GRD = ppa_sigGroup_AVL_FORC_GRD_sigGroup_AVL_FORC_GRD_au8[crcoffset_u16];
        AppData->ALIV_AVL_FORC_GRD = (ppa_sigGroup_AVL_FORC_GRD_sigGroup_AVL_FORC_GRD_au8[cntoffset_u16] & 0x0F);
    }

    if (status_u32 == status_ok_u32)
    {
        ret_u8 = Rte_Write_sigGroup_AVL_FORC_GRD_sigGroup_AVL_FORC_GRD ( AppData );
