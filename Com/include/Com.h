 ...
 *  Markus Bart                   visbms        Vctr Informatik GmbH
 *  Anant Gupta                   visgut        Vctr Informatik GmbH
 *  Buesra Bayrak                 visbbk        Vctr Informatik GmbH
 *  -------------------------------------------------------------------------------------------------------------------
 *  REVISION HISTORY
 *  -------------------------------------------------------------------------------------------------------------------
...
/*! \brief    This service starts I-PDU groups.
    \details  -
    \param    ipduGroupVctr I-PDU group vector containing the activation state (stopped = 0/ started = 1)
...
/*! \brief    This service enables or disables I-PDU group Deadline Monitoring.
    \details  -
    \param    ipduGroupVctr I-PDU group vector containing the requested deadline monitoring state
...
/*! \brief    This service sets all bits of the given Com_IpduGroupVector to 0.
    \details  -
    \param    ipduGroupVctr I-PDU group vector to be cleared
    \context  TASK
    \synchronous TRUE
    \reentrant   FALSE
    \trace   SPEC-2736971
...
/*! \brief    This service sets the value of a bit in an I-PDU group vector.
    \details  -
    \param    ipduGroupVctr I-PDU group vector to be modified
