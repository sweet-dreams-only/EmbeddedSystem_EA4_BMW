...
for /D %%G in ("..\..\*_EPS*_*") do set INTPJTDIR=%%G
...
xcopy ..\autosar\DlogClassic_paramdef.arxml    %INTPJTDIR%\tools\SIP\BSWMD\%SWC% /s
xcopy ..\autosar\Dlog_paramdef.arxml    %INTPJTDIR%\tools\SIP\BSWMD\%SWC% /s
pause
:end
