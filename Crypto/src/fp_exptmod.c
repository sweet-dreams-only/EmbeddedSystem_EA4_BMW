...
#error "Version of fp_exptmod.c does not match the version of the module!"
#endif
...
*/
static sint8 _fp_exptmod(fp_int * G, fp_int * X, fp_int * P, fp_int * Y)
{
  fp_int   R[2];
  fp_digit buf, mp;
  sint32      err, bitcnt, digidx, y;
...
static sint8 _fp_exptmod(fp_int * G, fp_int * X, fp_int * P, fp_int * Y)
{
  fp_int   M[64], res;
  fp_digit buf, mp;
  sint32   err, bitbuf, bitcpy, bitcnt, mode, digidx, x, y, winsize;
