...
<polyspace_project name="Polyspace" language="C" author="Nxtr" version="1.0" date="05/10/2016" path="file:/${polyspace_dir}/Polyspace.bf.psprj" source="Bug Finder" rev="1.4">
  <source>
