...
rmdir %INTPJTDIR%\tools\SIP\DaVinciConfigurator\Converters\%SWC% /s /q
...
mkdir %INTPJTDIR%\tools\SIP\DaVinciConfigurator\Converters\%SWC% 
...
xcopy ..\tools\IntegrationCopy\Converters       %INTPJTDIR%\tools\SIP\DaVinciConfigurator\Converters\%SWC% /s
